    ...
    return (
        <>
            <motion.header
                key="Header"
                aria-label="Header"
                className={`sticky top-0 lg:mt-2 md:mt-1.5 mt-1 w-full z-40 lg:px-8 md:px-6 px-2 transition-all duration-300 ease-in-out ${scrolled ? "h-[80px] md:h-[88px] bg-black/1 backdrop-blur border-b border-white/5" : "h-[104px] md:h-[120px]  bg-transparent border-b border-white/0 backdrop-blur-none"} `}
            >
