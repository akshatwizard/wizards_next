...
export const clients: Client[] = [
    {
        ...
        highlights: [
            ...
            "Monthly Instagram reporting (started September 2026) tracks real post-level performance — comments, a stronger buying-intent signal than likes, were up 16.9% this period",
        ],
        technicalOverview: {
